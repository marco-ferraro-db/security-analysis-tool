...
[GCP Specific variables](../standard/gcp.mdx) and navigate to the GCP section
...
Congratulations!!! [Please review the setup documentation for the instructions on usage, FAQs and general understanding of SAT setup](../../functionality.mdx)