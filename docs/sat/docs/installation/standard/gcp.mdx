...
Congratulations! 🎉 You are now ready to start using SAT. Please click here for a detailed description on how to run and use it.


## Troubleshooting
Please review the FAQs and Troubleshooting resources documented here including a notebook to help diagnose your SAT setup.
